...
from model.bfm import BFMModel
from model.utils.io import _load
from model.utils.functions import (
    crop_img, parse_roi_box_from_bbox, parse_roi_box_from_landmark,
)
from model.utils.tddfa_util import (
...
class TDDFA(object):
    ...
    def __init__(self, **kvs):
        ...
        # load BFM
        self.bfm = BFMModel(
            bfm_fp=kvs.get('bfm_fp', make_abs_path('model/configs/bfm_noneck_v3.pkl')),
