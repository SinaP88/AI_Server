...
class get_model(nn.Module):
    def __init__(self, num_classes, normal_channel=True):
        ...
        self.fp1 = PointNetFeaturePropagation(in_channel=135+additional_channel, mlp=[128, 128]) # should be pass to num of classes - 134 + num of classes
    ...
    def forward(self, xyz, cls_label):
        ...
        # cls_label_one_hot = cls_label.view(B,16,1).repeat(1,1,N) # 16 classes
